package com.ubt.alpha1e.edu.base.ResponseMode;
...
/**
 * @author：liuhai
 * @date：2018/1/17 20:08
 * @modifier：ubt
 * @modify_date：2018/1/17 20:08
 * [A brief description]
 * version
 */
...
public class MyRefreshFoot extends RelativeLayout implements RefreshFooter {
    ...
    public MyRefreshFoot(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs, 0);
    }

    public MyRefreshFoot(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    }
    ...
    public MyRefreshFoot setProgressBitmap(Bitmap bitmap) {
    ...
    public MyRefreshFoot setPrimaryColorId(@ColorRes int colorId) {
        setPrimaryColor(ContextCompat.getColor(getContext(), colorId));
        return this;
    }

    public MyRefreshFoot setAccentColorId(@ColorRes int colorId) {
        setAccentColor(ContextCompat.getColor(getContext(), colorId));
        return this;
    }

    public MyRefreshFoot setFinishDuration(int delay) {
        mFinishDuration = delay;
        return this;
    }

    public MyRefreshFoot setTextSizeTitle(float size) {
    ...
    public MyRefreshFoot setTextSizeTitle(int unit, float size) {
    ...
    public MyRefreshFoot setDrawableMarginRight(float dp) {
    ...
    public MyRefreshFoot setDrawableSize(float dp) {
        return setDrawableSizePx(DensityUtil.dp2px(dp));
    }

    public MyRefreshFoot setDrawableSizePx(int px) {
    ...
    public MyRefreshFoot setDrawableArrowSize(float dp) {
        return setDrawableArrowSizePx(DensityUtil.dp2px(dp));
    }

    public MyRefreshFoot setDrawableArrowSizePx(int px) {
        ViewGroup.LayoutParams lpArrow = mArrowView.getLayoutParams();
        lpArrow.width = px;
        lpArrow.height = px;
        mArrowView.setLayoutParams(lpArrow);
    ...
    public MyRefreshFoot setDrawableProgressSize(float dp) {
        return setDrawableProgressSizePx(DensityUtil.dp2px(dp));
    }

    public MyRefreshFoot setDrawableProgressSizePx(int px) {
        ViewGroup.LayoutParams lpProgress = mProgressView.getLayoutParams();
        lpProgress.width = px;
