...
import com.ubt.alpha1e.edu.library.AutoVideo.visibility.items.ListItem;
import com.ubt.alpha1e.edu.library.AutoVideo.visibility.items.VideoItem;
import com.ubt.alpha1e.edu.library.AutoVideo.visibility.scroll.ItemsProvider;
 ...
 */
public class SquareAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>implements ItemsProvider{
    ...
    private boolean isShowActionOnly = false;

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        mView = LayoutInflater.from(mContext).inflate(R.layout.actions_square_item, parent, false);
        SquareHolder mVideoHolder = new SquareHolder(mView);

        return mVideoHolder;
    }


    public SquareAdapter(Activity mActivity, Context context, List<Map<String,Object>> mDatas,
                         RecyclerView recyclerView, ActionsOnlineHelper mHelper,boolean isShowActionOnly)
    {
        ...
        this.isShowActionOnly = isShowActionOnly;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
           ...
           FillSquareContent.fillActionSquareContent(activity,mContext,(SquareHolder) holder,mDatas.get(position),mHelper,position,this.isShowActionOnly);
    ...
    public void setShowActionOnly(boolean isShowActionOnly){
        this.isShowActionOnly = isShowActionOnly;
    }
}
