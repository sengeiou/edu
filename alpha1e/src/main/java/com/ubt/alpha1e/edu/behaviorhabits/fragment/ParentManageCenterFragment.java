...
import com.ubt.alpha1e.edu.utils.DateUtils;
...
public class ParentManageCenterFragment extends MVPBaseFragment<BehaviorHabitsContract.View, BehaviorHabitsPresenter> implements BehaviorHabitsContract.View {
    ...
    protected void initUI() {
        ...
        userModel = (UserModel) SPUtils.getInstance().readObject(com.ubt.alpha1e.edu.base.Constant.SP_USER_INFO);
        ...
        switch (view.getId()) {
            ...
            case R.id.iv_title_right:
                ...
                String statisticsUrl = HttpEntity.HIBITS_STATISTICS
                        + "userid=" + SPUtils.getInstance().getString(com.ubt.alpha1e.edu.base.Constant.SP_USER_ID)
                        + "&token=" + SPUtils.getInstance().getString(com.ubt.alpha1e.edu.base.Constant.SP_LOGIN_TOKEN);
