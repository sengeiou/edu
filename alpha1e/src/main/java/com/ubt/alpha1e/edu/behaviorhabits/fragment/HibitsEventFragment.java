package com.ubt.alpha1e.edu.behaviorhabits.fragment;
...
import com.ubt.alpha1e.edu.behaviorhabits.adapter.HabitsEventRecyclerAdapter;
import com.ubt.alpha1e.edu.behaviorhabits.event.HibitsEvent;
import com.ubt.alpha1e.edu.behaviorhabits.helper.HabitsHelper;
...
import com.ubt.alpha1e.edu.ui.custom.CircleBar;
import com.ubt.alpha1e.edu.ui.dialog.ConfirmDialog;
import com.ubt.alpha1e.edu.ui.dialog.HibitsEventPlayDialog;
import com.ubt.alpha1e.edu.ui.dialog.InputPasswordDialog;
import com.ubt.alpha1e.edu.ui.dialog.SLoadingDialog;
import com.ubt.alpha1e.edu.ui.dialog.SetPasswordDialog;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case REFRESH_REQUEST_DATA:
                    UserModel userModel = (UserModel) SPUtils.getInstance().readObject(com.ubt.alpha1e.edu.base.Constant.SP_USER_INFO);
