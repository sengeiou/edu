...
public class CircleBar extends View {
    ...
    private int mTextColor = getResources().getColor(R.color.translate);//默认文字颜色
    private int mWheelColor = getResources().getColor(R.color.T25);//默认圆环颜色
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mDefaultWheelPaint.setColor(getResources().getColor(R.color.T30));
        ...
        textDesPaint.setColor(getResources().getColor(R.color.T30));
