package com.ubt.alpha1e.edu.library.AutoVideo.target;
...
import com.ubt.alpha1e.edu.library.AutoVideo.visibility.items.VideoLoadMvpView;
import com.ubt.alpha1e.edu.library.AutoVideo.widget.TextureVideoView;
...
public class VideoLoadTarget extends ViewTarget<TextureVideoView, File> implements TextureVideoView.MediaPlayerCallback {
    ...
    public void onCompletion(MediaPlayer mp) {
        // do nothing
        mLoadMvpView.videoComplete();
    }

    @Override
    public void onBufferingUpdate(MediaPlayer mp, int percent) {
        // do nothing
        mLoadMvpView.videoBuffering(percent);
