...
import com.ubt.alpha1e.edu.maincourse.courselayout.CourseLevelSevenLayout;
            ...
            mHelper.showStartHibitsProcess(new IDismissCallbackListener() {
                ...
                public void onDismissCallback(Object obj) {
                    ...
                    if ((boolean) obj) {
                        ...
                        mActionEdit.setData(CourseLevelSevenActivity.this);
        ...
        new ConfirmDialog(this).builder()
                ...
                .setPositiveButton("去连接", new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        UbtLog.d(TAG, "去连接蓝牙 ");
                        Intent intent = new Intent();
                        intent.setClass(CourseLevelSevenActivity.this, BluetoothconnectActivity.class);
