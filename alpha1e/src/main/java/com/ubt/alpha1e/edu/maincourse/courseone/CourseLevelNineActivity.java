...
import com.ubt.alpha1e.edu.maincourse.courselayout.CourseLevelNineLayout;
...
public class CourseLevelNineActivity extends MVPBaseActivity<CourseOneContract.View, CourseOnePresenter> implements CourseOneContract.View, IEditActionUI, CourseProgressListener, ActionsEditHelper.PlayCompleteListener {
            ...
            mHelper.showStartHibitsProcess(new IDismissCallbackListener() {
                ...
                public void onDismissCallback(Object obj) {
                    ...
                    if ((boolean) obj) {
                        ...
                        mActionEdit.setData(CourseLevelNineActivity.this);
    ...
    public void completeSuccess(boolean isSuccess) {
            ...
            returnCardActivity();
        mPresenter.savaCourseDataToDB(10, 1);
    }
        ...
        new ConfirmDialog(this).builder()
                ...
                .setPositiveButton("去连接", new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        UbtLog.d(TAG, "去连接蓝牙 ");
                        Intent intent = new Intent();
                        intent.setClass(CourseLevelNineActivity.this, BluetoothconnectActivity.class);
