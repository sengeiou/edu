...
import com.ubt.alpha1e.edu.ui.helper.IStartUI;
import com.ubt.alpha1e.edu.ui.helper.LoginHelper;
import com.ubt.alpha1e.edu.ui.helper.StartHelper;
...
//        initControlListener();
    ...
    private void startActivitySkip(){
        ...
        if (null == userModel) {
            inte.setClass(StartActivityNew.this, com.ubt.alpha1e.edu.login.LoginActivity.class);
        } else {
