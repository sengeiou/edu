...
public class DialogPreview extends Dialog {
    ...
    OnActionPreviewListener onActionPreviewListener;
    ...
    public DialogPreview(Context context, List<Map<String, Object>> list,  OnActionPreviewListener onActionPreviewListener) {
        super(context);
        this.context = context;
        dialogPreview = this;
        this.list = list;
        this.onActionPreviewListener = onActionPreviewListener;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                timer.cancel();
                if(onActionPreviewListener != null){
                    onActionPreviewListener.cancelAutoData();
                }
                list.clear();
                dismiss();
            }
    ...
    public interface OnActionPreviewListener{
        void cancelAutoData();
        void doPlayAutoRead();
    }
