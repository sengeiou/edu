...
public class WifiInfoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
     ...
     */
    public WifiInfoAdapter(Context mContext, List<ScanResult> list, Handler handler,String wifiName) {
        super();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        mView = LayoutInflater.from(mContext).inflate(R.layout.layout_wifi_item, parent, false);
