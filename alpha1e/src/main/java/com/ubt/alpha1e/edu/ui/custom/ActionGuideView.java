...
import static com.ubt.alpha1e.edu.base.Constant.SP_GUIDE_STEP;
...
public class ActionGuideView {
    ...
    public ActionGuideView(Context context, AppGuideCloseListener listener, float density) {
        mContext = context;
    ...
    private void createGuideView() {
        ...
        if(AlphaApplication.isPad()){
            ...
            rlGuideLayout = (RelativeLayout) inflater.inflate(R.layout.layout_action_guide, null);
        }
