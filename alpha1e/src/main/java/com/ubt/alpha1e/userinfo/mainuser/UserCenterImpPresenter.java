...
public class UserCenterImpPresenter extends BasePresenterImpl<UserCenterContact.UserCenterView> implements UserCenterContact.UserCenterPresenter {
    ...
    public void initData(Context context) {
        if (isAttachView()) {
            ...
            menuModel1.setImageId(R.drawable.radio_selector_main_left_info);
            ...
            menuModel2.setImageId(R.drawable.radio_selector_main_left_info);
            ...
            menuModel3.setImageId(R.drawable.radio_selector_main_left_info);
            ...
            menuModel4.setImageId(R.drawable.radio_selector_main_left_info);
            ...
            menuModel5.setImageId(R.drawable.radio_selector_main_left_info);
            ...
            menuModel6.setImageId(R.drawable.radio_selector_main_left_info);
