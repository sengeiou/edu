...
public class DynamicActionPresenter extends BasePresenterImpl<DynamicActionContract.View> implements DynamicActionContract.Presenter {
    ...
    private List<DynamicActionModel> getData() {
        ...
        dynamicActionModel1.setCreateTime("2013-11-11 18:35:35");
        ...
        dynamicActionModel11.setDownloadUrl("https://services.ubtrobot.com/action/16/3/蚂蚁与鸽子.zip");
        dynamicActionModel11.setActionTime(542000);
        dynamicActionModel11.setCreateTime("2013-11-11 18:35:35");
        ...
        dynamicActionModel12.setDownloadUrl("https://services.ubtrobot.com/action/16/3/蚂蚁与鸽子.zip");
        dynamicActionModel12.setActionTime(234510);
        dynamicActionModel12.setCreateTime("2013-11-11 18:35:35");
        ...
        dynamicActionModel13.setDownloadUrl("https://services.ubtrobot.com/action/16/3/蚂蚁与鸽子.zip");
        dynamicActionModel13.setActionTime(500000);
        dynamicActionModel13.setCreateTime("2017-12-26 14:35:35");
        ...
        dynamicActionModel2.setCreateTime("2017-12-25 18:35:35");
        ...
        dynamicActionModel3.setCreateTime("2017-12-26 17:15:35");
    ...
    public void praseDownloadData(Context context, DownloadProgressInfo downloadProgressInfo, List<DynamicActionModel> mDynamicActionModels) {
        ...
        if (downloadProgressInfo.status == 1) {//正在下载
            ...
            dynamicActionModel.setActionName("音乐轴");
