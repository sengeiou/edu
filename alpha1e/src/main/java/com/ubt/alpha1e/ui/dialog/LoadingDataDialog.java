...
public class LoadingDataDialog extends BaseDialog {
    ...
    private static LoadingDataDialog mDia;
    ...
    public static LoadingDataDialog getInstance(Context _context, BaseDiaUI _ui) {
        ...
        mDia = new LoadingDataDialog(_context);
    ...
    private void initDia() {
        ...
        View root = View.inflate(mContext, R.layout.dialog_data_loading, null);
