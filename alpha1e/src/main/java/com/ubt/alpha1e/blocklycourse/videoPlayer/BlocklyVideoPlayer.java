package com.ubt.alpha1e.blocklycourse.videoPlayer;
...
public class BlocklyVideoPlayer extends StandardGSYVideoPlayer {
    ...
    private static final String TAG = "BlocklyVideoPlayer";


    /**
     * 1.5.0开始加入，如果需要不同布局区分功能，需要重载
     */
    public BlocklyVideoPlayer(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public BlocklyVideoPlayer(Context context) {
        super(context);
    }

    public BlocklyVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public int getLayoutId() {
        return R.layout.blockly_video_player;
    }
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        BlocklyVideoPlayer sampleVideo = (BlocklyVideoPlayer) super.startWindowFullscreen(context, actionBar, statusBar);
...
//        resolveDanmakuSeek(this, time);
    ...
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, GSYVideoPlayer gsyVideoPlayer) {
        ...
        if (gsyVideoPlayer != null) {
            BlocklyVideoPlayer sampleVideo = (BlocklyVideoPlayer) gsyVideoPlayer;
...
//        super.updateStartImage();
        ImageView imageView1 = (ImageView)this.mStartButton;
        if(this.mCurrentState == 2) {
            imageView1.setImageResource(R.drawable.ic_pro_pause);
        } else if(this.mCurrentState == 7) {
            imageView1.setImageResource(R.drawable.ic_pro_play);
        } else {
            imageView1.setImageResource(R.drawable.ic_pro_play);
        }
    }
    ...
    protected void changeUiToPreparingShow() {
        ...
        setViewShowState(mLoadingProgressBar, INVISIBLE); //隐藏中间loading
