package com.ubt.alpha1e_edu.library.AutoVideo.widget;
...
public class TextureVideoView extends ScalableTextureView
    ...
    private static final int MSG_PLAY = 0x0005;
        ...
        synchronized (TextureVideoView.class) {
            switch (msg.what) {
                ...
                case MSG_START:
                    ...
                    break;
                case MSG_PLAY:
                    if(SHOW_LOGS) Log.i(TAG, "<< handleMessage play");
...
//            am.abandonAudioFocus(null);
    ...
    public void play() {
        ...
        if (!isPlaying()) {
            mVideoHandler.obtainMessage(MSG_PLAY).sendToTarget();
        }
    }
