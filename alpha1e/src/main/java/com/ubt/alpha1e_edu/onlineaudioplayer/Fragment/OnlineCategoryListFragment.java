package com.ubt.alpha1e_edu.onlineaudioplayer.Fragment;
...
import com.ubt.alpha1e_edu.adapter.onlineresAdpater;
...
import com.ubt.alpha1e_edu.onlineaudioplayer.DataObj.CategoryMax;
import com.ubt.alpha1e_edu.onlineaudioplayer.DataObj.OnlineresList;
import com.ubt.alpha1e_edu.onlineaudioplayer.helper.DividerItemDecorationNew;
import com.ubt.alpha1e_edu.onlineaudioplayer.categoryActivity.OnlineAudioPlayerContract;
import com.ubt.alpha1e_edu.onlineaudioplayer.categoryActivity.OnlineAudioPlayerPresenter;
import com.ubt.alpha1e_edu.onlineaudioplayer.helper.OnlineAudioResourcesHelper;
...
import com.ubt.alpha1e_edu.onlineaudioplayer.model.PlayerEvent;
import com.ubt.alpha1e_edu.onlineaudioplayer.searchActivity.OnlineResRearchActivity;
...
//                        startActivityForResult(mIntent,REQUEST_RESULT_PLAYLIST);
    ...
    public void getMaxCategory() {
        com.ubt.alpha1e_edu.base.loading.LoadingDialog.show(getActivity());
            ...
            public void onError(Call call, Exception e, int id) {
                ...
                switch (id) {
                    case GET_MAX_CATEGORY:
                        com.ubt.alpha1e_edu.base.loading.LoadingDialog.dismiss(getActivity());
