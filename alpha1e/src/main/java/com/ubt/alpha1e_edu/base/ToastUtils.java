...
/**
 * @author：liuhai
 * @date：2017/10/28 15:57
 * @modifier：ubt
 * @modify_date：2017/10/28 15:57
 * [A brief description]
 * version
 */
...
public class ToastUtils {
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(AlphaApplication.mContext.getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(AlphaApplication.mContext.getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = Toast.makeText(AlphaApplication.mContext, text, duration);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        ...
        LayoutInflater inflate = (LayoutInflater) AlphaApplication.mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
