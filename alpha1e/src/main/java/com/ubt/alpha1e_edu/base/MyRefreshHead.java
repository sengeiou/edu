package com.ubt.alpha1e_edu.base;
...
//    public static String REFRESH_HEADER_LASTTIME = "'Last update' M-d HH:mm";
    ...
    public MyRefreshHead(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public MyRefreshHead setProgressBitmap(Bitmap bitmap) {
        mProgressDrawable = null;
        mProgressView.setImageBitmap(bitmap);
        return this;
    }

    public MyRefreshHead setProgressDrawable(Drawable drawable) {
        mProgressDrawable = null;
        mProgressView.setImageDrawable(drawable);
        return this;
    }

    public MyRefreshHead setProgressResource(@DrawableRes int resId) {
        mProgressDrawable = null;
        mProgressView.setImageResource(resId);
        return this;
    }

    public MyRefreshHead setArrowBitmap(Bitmap bitmap) {
        mArrowDrawable = null;
        mArrowView.setImageBitmap(bitmap);
        return this;
    }

    public MyRefreshHead setArrowDrawable(Drawable drawable) {
        mArrowDrawable = null;
        mArrowView.setImageDrawable(drawable);
        return this;
    }

    public MyRefreshHead setArrowResource(@DrawableRes int resId) {
        mArrowDrawable = null;
        mArrowView.setImageResource(resId);
        return this;
    }

    public MyRefreshHead setLastUpdateTime(Date time) {
        mLastTime = time;
    ...
    public MyRefreshHead setLastUpdateText(CharSequence text) {
        mLastTime = null;
        mLastUpdateText.setText(text);
        return this;
    }

    public MyRefreshHead setTimeFormat(DateFormat format) {
        mFormat = format;
        if (mLastTime != null) {
    ...
    public MyRefreshHead setSpinnerStyle(SpinnerStyle style) {
        this.mSpinnerStyle = style;
        return this;
    }

    public MyRefreshHead setPrimaryColor(@ColorInt int primaryColor) {
    ...
    public MyRefreshHead setAccentColor(@ColorInt int accentColor) {
    ...
    public MyRefreshHead setPrimaryColorId(@ColorRes int colorId) {
        setPrimaryColor(ContextCompat.getColor(getContext(), colorId));
        return this;
    }

    public MyRefreshHead setAccentColorId(@ColorRes int colorId) {
        setAccentColor(ContextCompat.getColor(getContext(), colorId));
        return this;
    }

    public MyRefreshHead setFinishDuration(int delay) {
        mFinishDuration = delay;
        return this;
    }

    public MyRefreshHead setEnableLastTime(boolean enable) {
    ...
    public MyRefreshHead setTextSizeTitle(float size) {
    ...
    public MyRefreshHead setTextSizeTitle(int unit, float size) {
    ...
    public MyRefreshHead setTextSizeTime(float size) {
    ...
    public MyRefreshHead setTextSizeTime(int unit, float size) {
    ...
    public MyRefreshHead setTextTimeMarginTop(float dp) {
        return setTextTimeMarginTopPx(DensityUtil.dp2px(dp));
    }

    public MyRefreshHead setTextTimeMarginTopPx(int px) {
    ...
    public MyRefreshHead setDrawableMarginRight(float dp) {
        return setDrawableMarginRightPx(DensityUtil.dp2px(dp));
    }

    public MyRefreshHead setDrawableMarginRightPx(int px) {
    ...
    public MyRefreshHead setDrawableSize(float dp) {
        return setDrawableSizePx(DensityUtil.dp2px(dp));
    }

    public MyRefreshHead setDrawableSizePx(int px) {
    ...
    public MyRefreshHead setDrawableArrowSize(float dp) {
        return setDrawableArrowSizePx(DensityUtil.dp2px(dp));
    }

    public MyRefreshHead setDrawableArrowSizePx(int px) {
        ViewGroup.LayoutParams lpArrow = mArrowView.getLayoutParams();
        lpArrow.width = px;
        lpArrow.height = px;
        mArrowView.setLayoutParams(lpArrow);
    ...
    public MyRefreshHead setDrawableProgressSize(float dp) {
        return setDrawableProgressSizePx(DensityUtil.dp2px(dp));
    }

    public MyRefreshHead setDrawableProgressSizePx(int px) {
        ViewGroup.LayoutParams lpProgress = mProgressView.getLayoutParams();
        lpProgress.width = px;
