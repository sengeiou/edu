...
import com.ubt.alpha1e_edu.blockly.sensor.SensorHelper;
import com.ubt.alpha1e_edu.blockly.sensor.SensorObservable;
import com.ubt.alpha1e_edu.blockly.sensor.SensorObserver;
...
import com.ubt.alpha1e_edu.data.ZipTools;
...
import com.ubt.alpha1e_edu.data.model.LessonTaskResultInfo;
...
import com.ubt.alpha1e_edu.event.LessonEvent;
...
import com.ubt.alpha1e_edu.ui.RobotNetConnectActivity;
import com.ubt.alpha1e_edu.ui.custom.IOnClickListener;
...
import com.ubt.alpha1e_edu.ui.dialog.LessonTaskFinishDialog;
import com.ubt.alpha1e_edu.ui.dialog.LessonTaskHelpDialog;
import com.ubt.alpha1e_edu.ui.dialog.LessonTaskSuccessDialog;
import com.ubt.alpha1e_edu.ui.dialog.ShareDialog;
import com.ubt.alpha1e_edu.ui.dialog.SyncDownloadAlertDialog;
import com.ubt.alpha1e_edu.ui.helper.ActionsEditHelper;
import com.ubt.alpha1e_edu.ui.helper.BaseHelper;
import com.ubt.alpha1e_edu.ui.helper.CourseHelper;
import com.ubt.alpha1e_edu.ui.helper.IActionsUI;
import com.ubt.alpha1e_edu.ui.helper.IEditActionUI;
import com.ubt.alpha1e_edu.ui.helper.IRemoteUI;
    ...
    public void saveUserProgram(final String pid, final String programName, final String programData){
        ...
        OkHttpClientUtils.getJsonByPostRequest(HttpEntity.SAVE_USER_PROGRAM, request, 0).execute(new StringCallback() {
            ...
            public void onError(Call call, Exception e, int id) {
                ...
                blocklyProjectMode.setUserId(SPUtils.getInstance().getString(com.ubt.alpha1e_edu.base.Constant.SP_USER_ID));
