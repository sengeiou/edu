package com.ubt.alpha1e_edu.ui.dialog.alertview;
...
public class SheetAlertView {
    ...
    private List<SpannableString> mOthers;
    private SpannableString cancel;
    private ArrayList<SpannableString> mDatas = new ArrayList<SpannableString>();
    ...
    public SheetAlertView(String title, String msg, SpannableString cancel, SpannableString[] destructive, SpannableString[] others, Context context, Style style, OnItemClickListener onItemClickListener){
     ...
     * 获取数据
     */
    protected void initData(String title, String msg, SpannableString cancel, SpannableString[] destructive, SpannableString[] others) {
    ...
    protected void initListView(){
        ...
        SheetAlertViewAdapter adapter = new SheetAlertViewAdapter(mDatas,mDestructive);
        ...
        alertButtonListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                if(onItemClickListener != null)onItemClickListener.onItemClick(SheetAlertView.this,position);
                dismiss();
            }
        });
    }
    ...
    protected void initAlertViews(LayoutInflater layoutInflater) {
        ...
        if(mDatas.size()<=HORIZONTAL_BUTTONS_MAXCOUNT){
            ...
            for (int i = 0; i < mDatas.size(); i ++) {
                ...
                SpannableString data = mDatas.get(i);
    ...
    public SheetAlertView addExtView(View extView){
                ...
                decorView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (onDismissListener != null) {
                            onDismissListener.onDismiss(SheetAlertView.this);
                        }
                    }
                });
            }
    ...
    public SheetAlertView setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    public SheetAlertView setCancelable(boolean isCancelable) {
