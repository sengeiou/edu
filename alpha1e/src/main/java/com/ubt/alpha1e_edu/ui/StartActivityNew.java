...
import com.ubt.alpha1e_edu.ui.helper.IStartUI;
import com.ubt.alpha1e_edu.ui.helper.LoginHelper;
import com.ubt.alpha1e_edu.ui.helper.StartHelper;
...
//        initControlListener();
    ...
    private void startActivitySkip(){
        ...
        if (null == userModel) {
            inte.setClass(StartActivityNew.this, com.ubt.alpha1e_edu.login.LoginActivity.class);
        } else {
