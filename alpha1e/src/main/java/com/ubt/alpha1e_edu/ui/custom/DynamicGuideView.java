...
public class DynamicGuideView {
    ...
    private void createGuideView() {
        ...
        rlGuideLayout = (RelativeLayout) inflater.inflate(R.layout.layout_dynamic_guid, null);
    ...
    public void recordDynamicGuideState() {
        BasicSharedPreferencesOperator.getInstance(mContext, BasicSharedPreferencesOperator.DataType.USER_USE_RECORD).doWrite(BasicSharedPreferencesOperator.KEY_DYNAMIC_GUIDE_SHOW_STATE,
                "true", null, -1);
    }

    public static boolean isShowDynamicGuide(BaseActivity mActivity) {
        String dubState = BasicSharedPreferencesOperator.getInstance(mActivity, BasicSharedPreferencesOperator.DataType.USER_USE_RECORD).doReadSync(BasicSharedPreferencesOperator.KEY_DYNAMIC_GUIDE_SHOW_STATE);
