...
import com.ubt.alpha1e_edu.business.FileSendManager;
...
import com.ubt.alpha1e_edu.services.ActivationService;
import com.ubt.alpha1e_edu.services.AutoScanConnectService;
import com.ubt.alpha1e_edu.services.RecordSoftService;
...
import com.ubt.alpha1e_edu.update.IBluetoothUpdateManagerListener;
import com.ubt.alpha1e_edu.update.IEngineUpdateManagerListener;
import com.ubt.alpha1e_edu.update.RobotSoftUpdateManager;
...
public class ScanHelper extends BaseHelper implements IJsonListener,
...
//                        doUpdateUI();//need finish activity
    ...
    public ScanHelper(IScanUI _ui, Context context) {
        super(context);
    ...
    private void doDealConnectSuccessResult(){
        ...
        // 激活机器人
        ScanHelper.this.doActivate();
        // 记录机器人版本号
        ScanHelper.this.doRecordSoftVersion();
        // 设置机器边充边玩状态
