 ...
 */
public class NetConnectAlertDialog {
    ...
    public NetConnectAlertDialog(Context context) {
    ...
    public NetConnectAlertDialog builder() {
        // 获取Dialog布局
    ...
    public NetConnectAlertDialog setTitle(String title) {
        showTitle = true;
        if ("".equals(title)) {
    ...
    public NetConnectAlertDialog setMsg(String msg) {
        showMsg = true;
        if ("".equals(msg)) {
            txt_msg.setText("内容");
        } else {
    ...
    public NetConnectAlertDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public NetConnectAlertDialog setPositiveButton(String text,
    ...
    public NetConnectAlertDialog setNegativeButton(String text,
                                                   final View.OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("取消");
    ...
    public NetConnectAlertDialog setImageResoure(int id) {
        showImg = true;
