...
import static com.pbq.imagepicker.jcamera.JCameraView.BUTTON_STATE_ONLY_RECORDER;


public class CaptureButton2 extends View {

    private static final String TAG = CaptureButton2.class.getSimpleName();
    ...
    private int progress_color = 0xFF02AAE8;            //进度条颜色0xEE16AE16
    private int outside_color = 0x33FFFFFF;             //外圆背景色
    ...
    public CaptureButton2(Context context, int size) {
        ...
        button_inside_radius = button_radius * 0.70f;

        strokeWidth = size / 25;
        outside_add_size = size / 8;
        inside_reduce_size = size / 25;
