...
public class ImageCropActivity extends ImageBaseActivity implements View.OnClickListener, CropImageView.OnBitmapSaveCompleteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.pbq.imagepicker.R.layout.imagepick_activity_image_crop);

        imagePicker = ImagePicker.getInstance();

        //初始化View
        findViewById(com.pbq.imagepicker.R.id.btn_back).setOnClickListener(this);
        Button btn_ok = (Button) findViewById(com.pbq.imagepicker.R.id.btn_ok);
        btn_ok.setText(getString(com.pbq.imagepicker.R.string.complete));
        btn_ok.setOnClickListener(this);
        TextView tv_des = (TextView) findViewById(com.pbq.imagepicker.R.id.tv_des);
        tv_des.setText(getString(com.pbq.imagepicker.R.string.photo_crop));
        mCropImageView = (CropImageView) findViewById(com.pbq.imagepicker.R.id.cv_crop_image);
...
//        mCropImageView.setImageURI(Uri.fromFile(new File(imagePath)));
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == com.pbq.imagepicker.R.id.btn_back) {
            setResult(RESULT_CANCELED);
            finish();
        } else if (id == com.pbq.imagepicker.R.id.btn_ok) {
