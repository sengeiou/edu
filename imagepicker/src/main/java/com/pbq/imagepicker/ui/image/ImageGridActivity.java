...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageGridAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.pbq.imagepicker.R.layout.imagepick_activity_image_grid);
        ...
        findViewById(com.pbq.imagepicker.R.id.btn_back).setOnClickListener(this);
        mBtnOk = (Button) findViewById(com.pbq.imagepicker.R.id.btn_ok);
        mBtnOk.setOnClickListener(this);
        mBtnDir = (Button) findViewById(com.pbq.imagepicker.R.id.btn_dir);
        mBtnDir.setOnClickListener(this);
        mBtnPre = (Button) findViewById(com.pbq.imagepicker.R.id.btn_preview);
        mBtnPre.setOnClickListener(this);
        mGridView = (GridView) findViewById(com.pbq.imagepicker.R.id.gridview);
        mFooterBar = findViewById(com.pbq.imagepicker.R.id.footer_bar);
    ...
    public void onClick(View v) {
        ...
        } else if (id == com.pbq.imagepicker.R.id.btn_preview) {
        ...
        } else if (id == com.pbq.imagepicker.R.id.btn_back) {
            //点击返回按钮
            finish();
        }
    }
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        ...
        if (imagePicker.getSelectImageCount() > 0) {
            mBtnOk.setText(getString(com.pbq.imagepicker.R.string.select_complete, imagePicker.getSelectImageCount(), imagePicker.getSelectLimit()));
            mBtnOk.setEnabled(true);
            mBtnPre.setEnabled(true);
        } else {
            mBtnOk.setText(getString(com.pbq.imagepicker.R.string.complete));
            mBtnOk.setEnabled(false);
            mBtnPre.setEnabled(false);
        }
        mBtnPre.setText(getResources().getString(com.pbq.imagepicker.R.string.preview_count, imagePicker.getSelectImageCount()));
