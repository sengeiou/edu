package com.pbq.imagepicker.jcamera;
...
import com.pbq.imagepicker.jcamera.listener.CaptureListener;
...
import com.pbq.imagepicker.jcamera.state.CameraMachine;
import com.pbq.imagepicker.jcamera.util.FileUtil;
import com.pbq.imagepicker.jcamera.util.ScreenUtils;
import com.pbq.imagepicker.jcamera.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconSrc = a.getResourceId(R.styleable.JCameraView_iconSrc, R.drawable.imagepick_btn_camera);
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.imagepick_camera_view, this);
