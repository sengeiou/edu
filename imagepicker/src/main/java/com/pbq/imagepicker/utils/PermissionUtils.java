package com.pbq.imagepicker.utils;
...
import com.pbq.imagepicker.dialog.ConfirmDialog;
...
public class PermissionUtils {
    ...
    public void showRationSettingDialog(PermissionEnum permission, Context context, final PermissionLocationCallback callback) {
        ...
        switch (permission) {
            case LOACTION:
                message = mContext.getString(R.string.imagepick_dialog_permission_location_setting);
                break;
            case CAMERA:
                message = mContext.getString(R.string.imagepick_dialog_permission_camera_setting);
                break;
            case STORAGE:
                message = mContext.getString(R.string.imagepick_dialog_permission_storage_setting);
                break;
            case MICROPHONE:
                message = mContext.getString(R.string.imagepick_dialog_permission_microphone_setting);
                break;
            default:
                break;
        }
        ...
        new ConfirmDialog(context).builder()
                .setMsg(message)
                .setCancelable(true)
                .setPositiveButton(mContext.getString(R.string.imagepick_dialog_go_setting), new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        settingService.execute();
                    }
                }).setNegativeButton(mContext.getString(R.string.ui_common_cancel), new View.OnClickListener() {
            @Override
