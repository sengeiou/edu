...
/**
 * @author：liuhai
 * @date：2017/11/1 14:15
 * @modifier：ubt
 * @modify_date：2017/11/1 14:15
 * [A brief description]
 * version
 */
...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        ...
        if(MediaGridActivity.getContextInstanse() != null) {
            sp = MediaGridActivity.getContextInstanse().getSharedPreferences(spName, Context.MODE_PRIVATE);
        }
    }
