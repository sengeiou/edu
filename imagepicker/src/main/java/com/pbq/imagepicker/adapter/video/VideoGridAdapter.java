...
public class VideoGridAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (itemViewType == ITEM_TYPE_CAMERA) {
            convertView = LayoutInflater.from(mActivity).inflate(com.pbq.imagepicker.R.layout.imagepick_adapter_record_item, parent, false);
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(mActivity).inflate(com.pbq.imagepicker.R.layout.imagepick_adapter_video_item, parent, false);
                convertView.setLayoutParams(new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, mVideoSize)); //让视频是个正方形
            ...
            Glide.with(mActivity)
                    .load(videoItem.path)
                    .placeholder(R.mipmap.imagepick_default_image)
